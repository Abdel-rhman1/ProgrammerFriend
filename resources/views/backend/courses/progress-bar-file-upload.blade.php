    ...
    <div class="card">
      ...
      <div class="card-body">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input type="number" class="form-control"  id ="LessonNumber" placeholder="Type This Item Belong To any Lesson">
            </div>
        </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <select class="form-control">
                        <option vlaue="mp3">MP3</option>
                        <option vlaue="mp3">MP4</option>
    ...
    $(function() {
      ...
      $('form').ajaxForm({
        ...
        complete: function(xhr) {
            ...
            window.location.href = SITEURL +"/"+"store";
        }
      });
   }); 
 });
